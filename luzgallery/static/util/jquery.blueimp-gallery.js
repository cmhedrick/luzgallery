! function(a) {
    ...
    return a.extend(b.prototype, {
        ...
        handleSlide: function(a) {
            this.options.continuous || this.updateEdgeClasses(a), this.loadElements(a), this.options.unloadElements && this.unloadElements(a), this.setTitle(a), this.setDis(a)
        },
        onslide: function(a) {
        ...
        setDis: function(a) {
            var b = this.slides[a].firstChild.dis,
                c = this.disElement;
            console.log(b), c.length && (this.disElement.empty(), b && c[0].appendChild(document.createTextNode(b)))
        },
        ...
        imageFactory: function(b, c) {
            ...
            //return "string" != typeof i && (i = this.getItemProperty(b, this.options.urlProperty), f = this.getItemProperty(b, this.options.titleProperty), z = this.getItemProperty(b, this.options.disProperty)), j === !0 && (j = "contain"), j = this.support.backgroundSize && this.support.backgroundSize[j] && j, j ? e = this.elementPrototype.cloneNode(!1) : (e = h, h.draggable = !1), f && (e.title = f), z && (e.dis = z), a(h).on("load error", k), h.src = i, e
        ...
        initWidget: function() {
            ...
            //return this.container = a(this.options.container), this.container.length ? (this.slidesContainer = this.container.find(this.options.slidesContainer).first(), this.slidesContainer.length ? (this.titleElement = this.container.find(this.options.titleElement).first(), this.slidesContainer.length ? (this.disElement = this.container.find(this.options.disElement).first(), 1 === this.num && this.container.addClass(this.options.singleClass), this.options.onopen && this.options.onopen.call(this), this.support.transition && this.options.displayTransition ? this.container.on(this.support.transition.end, c) : this.handleOpen(), this.options.hidePageScrollbars && (this.bodyOverflowStyle = document.body.style.overflow, document.body.style.overflow = "hidden"), this.container[0].style.display = "block", this.initSlides(), void this.container.addClass(this.options.displayClass)) : (this.console.log("blueimp Gallery: Slides container not found.", this.options.slidesContainer), !1)) : (this.console.log("blueimp Gallery: Widget container not found.", this.options.container), !1)
    ...
    return a.extend(b.prototype, {
        createIndicator: function(b) {
            var c, d, e = this.indicatorPrototype.cloneNode(!1),
                ...
                //z = this.getItemProperty(b, this.options.disProperty)
                g = this.options.thumbnailProperty;
//            return this.options.thumbnailIndicators && (d = b.getElementsByTagName && a(b).find("img")[0], d ? c = d.src : g && (c = this.getItemProperty(b, g)), c && (e.style.backgroundImage = 'url("' + c + '")')), f && (e.title = f), z && (e.dis = z), e
    ...
    return a.extend(b.prototype, {
        ...
        videoFactory: function(b, c, d) {
            var e, f, g, h, i, j = this,
                ...
                //z = this.getItemProperty(b, k.disProperty),
